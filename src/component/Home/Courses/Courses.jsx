...
function Courses() {
  ...
  useEffect(() => {
    ...
    .then((data) => {setProducts(data.products);setError(false)
      setFilterProductData(data.products)
    })
    .catch((error) => {console.error("Error fetching", error);setError(true)}
  );
  }, []);
  ...
  let btn =
  "bg-red-500 pl-[14px] pr-[14px] pt-[8px] pb-[8px] rounded-full no-underline text-white hover:bg-red-700 transition duration-300";
          ...
          <div>
            <ul className="flex">
              ...
              <li className="mr-[10px]">
                <Link
                  className={classNames(
                    location.pathname === navigation[1].href
                      ? btn
                      : "text-black !font-bold no-underline bg-white ",
                    " px-3 py-2 text-sm font-medium no-underline"
                  )}
              ...
              <li>
                <Link
                  className={classNames(
                    location.pathname === navigation[2].href
                      ? btn
                      : "text-black !font-bold no-underline bg-white ",
                    " px-3 py-2 text-sm font-medium no-underline"
                  )}
